...
# Collsion for Obstacle 4
        if rightBall >= rectPos_4.x and leftBall <= (rectPos_4.x + 30):
            collision = 1
        elif bottomBall >= (height - (height - rectPos_4.y)) or  topBall <= 220:
            collision = 1
...
# Collision for Obstacle 5
        if rightBall >= rectPos_5.x and leftBall <= (rectPos_5.x + 30):
            collision = 1
        elif topBall <= 275:
            collision = 1
...
def mousePressed():
    ...
    global collision
# Press start button
    if mouseX <= 490 and mouseY <= 180 and screen == "startscreen":
        screen = "gamescreen"
        reset()
    elif mouseX >= 420 and mouseY >= 150 and screen == "startscreen":
        screen = "gamescreen"
        reset()
# Press instructions button
    if mouseX <= 590 and mouseY <= 230 and screen == "startscreen":
        screen = "Instructions"
    elif mouseX >= 420 and mouseY >= 200 and screen == "startscreen":
        screen = "Instructions"
# Press back button
    if mouseX <= 150 and mouseY <= 380 and screen == "Instructions":
        screen = "startscreen"
    elif mouseX >= 50 and mouseY >= 350 and screen == "Instructions":
        screen = "startscreen"
# Play again from Game Over screen
    if mouseX <= 500 and mouseY <= 158 and screen == "gameover":
        screen = "gamescreen"
        reset()
    elif mouseX >= 350 and mouseY >= 125 and screen == "gameover":
        screen = "gamescreen"
        reset()
# Go to Start Screen by Pressing Exit
    if mouseX <= 450 and mouseY <= 203 and screen == "gameover":
        screen = "startscreen"
